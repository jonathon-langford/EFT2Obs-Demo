...
namespace STXS {
  ...
  namespace Stage1_1_Fine {
    ...
    template <class category>
      ...
      cat.stage1_cat_pTjet25GeV = stxs_cat_rivet.stage1_cat_pTjet25GeV;
      cat.stage1_cat_pTjet30GeV = stxs_cat_rivet.stage1_cat_pTjet30GeV;
...
namespace Rivet {
  ...
  struct HiggsClassification {
    ...
    /// Stage-1 STXS event classifcation, see: https://cds.cern.ch/record/2138079
    STXS::Stage1::Category stage1_cat_pTjet30GeV;
    /// Stage-1_1 STXS event classifcation, see: https://cds.cern.ch/record/2138079
    STXS::Stage1_1::Category stage1_1_cat_pTjet25GeV;
    /// Stage-1_1 STXS event classifcation, see: https://cds.cern.ch/record/2138079
    STXS::Stage1_1::Category stage1_1_cat_pTjet30GeV;
