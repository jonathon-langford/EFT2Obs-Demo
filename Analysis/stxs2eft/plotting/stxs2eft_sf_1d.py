...
#stxsColorMap = {"QQ2HQQ_VBFTOPO_JET3VETO":807,"QQ2HQQ_VBFTOPO_JET3":804,"QQ2HQQ_VH2JET":803,"QQ2HQQ_REST":632,"QQ2HQQ_PTJET1_GT200":800}
stxsColorMap = {"QQ2HQQ_VBFTOPO_JET3VETO":807,"QQ2HQQ_VBFTOPO_JET3":804,"QQ2HQQ_VH2JET":803,"QQ2HQQ_REST":632,"QQ2HQQ_PTJET1_GT200":800}
#stxsColorMap = {"QQ2HQQ_VBFTOPO_JET3VETO":616,"QQ2HQQ_VBFTOPO_JET3":619,"QQ2HQQ_VH2JET":894,"QQ2HQQ_REST":874,"QQ2HQQ_PTJET1_GT200":890}
...
for stxs_bin in STXS_bins[s]:
  if stxs_bin.split("_")[0] == procToSTXSProductionModeMap[process]:
    ...
    #if "JET3VETO" not in stxs_bin: continue
...
if opt.plotUncertainties:
  for gr in gr_mu.itervalues(): gr.Draw("Same E")
else: 
...
if opt.plotLHCHXSWG:
  ...
  # Draw
  h_axes_r.Draw()
  for gr in gr_mu_r.itervalues(): gr.Draw("Same E")

  # Draw lines in ratio plot
  if (max_r-min_r)>0.5: step = 0.2
  else: step = 0.1
  l_pos = np.arange(0,2,step).tolist()
  l_r = {}
  litr = 0
  for l in l_pos:
    if(l>min_r)&(l<max_r):
